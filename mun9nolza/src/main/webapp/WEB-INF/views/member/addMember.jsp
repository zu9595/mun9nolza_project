				...
				<form action="addMember.do" method="post" class="validation-form"
					...
					<div class="col-xs-12 col-md-6 mb-3" style="margin-left: 15px;">
						<br> <label for="id" style="margin-top: 5px;">아이디</label> <input
							...
							style="width: 380px;" id="id"> <label for="pw"
							style="margin-top: 5px;">비밀번호</label> <input type="password"
							name="userPw" class="form-control" required style="width: 380px;"
							id="pw"> <label for="pwCheck" style="margin-top: 5px;">비밀번호
							확인</label> <input type="password" class="form-control" required
							style="width: 380px;" id="pwCheck"> <br> <label
							for="name" style="margin-top: 5px;">이름</label> <input type="text"
                      ...
                      <input type="text" class="form-control" placeholder="8자리" required style="width: 380px;"
                        id="birth"> -->
						<br> <label for="gender" style="margin-top: 5px;">성별</label>
						<br>
						<div class="genderBox">
							<label for="gender">남성</label> <input type='radio' id='gender'
								name='gender' value='남' /> <label for="gender">여성</label> <input
								type='radio' id='gender' name='gender' value='여' />
						</div>
