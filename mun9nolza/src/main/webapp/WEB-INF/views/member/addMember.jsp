          ...
          <div class="container">
            <div class="input-form-backgroud row">
              <div class="input-form col-md-5 mx-auto">
                ...
                <!-- 서버로 정보전송 -->
                <form action="addMember.do" method="post" class="validation-form" novalidate>
                  <!-- <div class="row"> -->

                    <div class="col-xs-12 col-md-6 mb-3" style="margin-left:15px;">
                      <br>
                      <label for="id" style="margin-top: 5px;">아이디</label>
                      <input type="text" name="userId" class="form-control" required style="width: 380px;" id="id">
                      ...
                      <input type="text" name="userName" class="form-control" required style="width: 380px;" id="name">
                      ...
                      <label for="phone" required style="margin-top: 20px;">휴대전화</label>
                        ...
                        <span> - </span>
                        <input type="tel" class="form-control" id="phone1" name="phoneNum2" style="width: 100px;">
                        <span> - </span>
                        <input type="tel" class="form-control" id="phone2" name="phoneNum3" style="width: 100px;">
                        <br>
                        <label for="email">이메일</label>
                        <input type="email" class="form-control" id="email" name="email" style="width: 380px;" placeholder="you@mun9nolza.com" id="email">
                    </div>
                  <!-- </div> -->
              <br>
